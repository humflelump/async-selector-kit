...
export declare function createSubscription<R1, R2, AsyncReturn, State, Props = undefined, DefaultValue = undefined>(params: {
    onSubscribe?: (inputs: [R1, R2], setter: (val: DefaultValue) => void) => void;
    onUnsubscribe?: (inputs: [R1, R2], setter: (val: DefaultValue) => void) => void;
...
export declare function createSubscription<R1, R2, R3, AsyncReturn, State, Props = undefined, DefaultValue = undefined>(params: {
    onSubscribe?: (inputs: [R1, R2, R3], setter: (val: DefaultValue) => void) => void;
    onUnsubscribe?: (inputs: [R1, R2, R3], setter: (val: DefaultValue) => void) => void;
...
export declare function createSubscription<R1, R2, R3, R4, AsyncReturn, State, Props = undefined, DefaultValue = undefined>(params: {
    onSubscribe?: (inputs: [R1, R2, R3, R4], setter: (val: DefaultValue) => void) => void;
    onUnsubscribe?: (inputs: [R1, R2, R3, R4], setter: (val: DefaultValue) => void) => void;
...
export declare function createSubscription<R1, R2, R3, R4, R5, AsyncReturn, State, Props = undefined, DefaultValue = undefined>(params: {
    onSubscribe?: (inputs: [R1, R2, R3, R4, R5], setter: (val: DefaultValue) => void) => void;
    onUnsubscribe?: (inputs: [R1, R2, R3, R4, R5], setter: (val: DefaultValue) => void) => void;
...
export declare function createSubscription<R1, R2, R3, R4, R5, R6, AsyncReturn, State, Props = undefined, DefaultValue = undefined>(params: {
    onSubscribe?: (inputs: [R1, R2, R3, R4, R5, R6], setter: (val: DefaultValue) => void) => void;
    onUnsubscribe?: (inputs: [R1, R2, R3, R4, R5, R6], setter: (val: DefaultValue) => void) => void;
...
export declare function createSubscription<R1, R2, R3, R4, R5, R6, R7, AsyncReturn, State, Props = undefined, DefaultValue = undefined>(params: {
    onSubscribe?: (inputs: [R1, R2, R3, R4, R5, R6, R7], setter: (val: DefaultValue) => void) => void;
    onUnsubscribe?: (inputs: [R1, R2, R3, R4, R5, R6, R7], setter: (val: DefaultValue) => void) => void;
...
export declare function createSubscription<R1, R2, R3, R4, R5, R6, R7, R8, AsyncReturn, State, Props = undefined, DefaultValue = undefined>(params: {
    onSubscribe?: (inputs: [R1, R2, R3, R4, R5, R6, R7, R8], setter: (val: DefaultValue) => void) => void;
    onUnsubscribe?: (inputs: [R1, R2, R3, R4, R5, R6, R7, R8], setter: (val: DefaultValue) => void) => void;
...
export declare function createSubscription<R1, R2, R3, R4, R5, R6, R7, R8, R9, AsyncReturn, State, Props = undefined, DefaultValue = undefined>(params: {
    onSubscribe?: (inputs: [R1, R2, R3, R4, R5, R6, R7, R8, R9], setter: (val: DefaultValue) => void) => void;
    onUnsubscribe?: (inputs: [R1, R2, R3, R4, R5, R6, R7, R8, R9], setter: (val: DefaultValue) => void) => void;
...
export declare function createSubscription<R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, AsyncReturn, State, Props = undefined, DefaultValue = undefined>(params: {
    onSubscribe?: (inputs: [R1, R2, R3, R4, R5, R6, R7, R8, R9, R10], setter: (val: DefaultValue) => void) => void;
    onUnsubscribe?: (inputs: [R1, R2, R3, R4, R5, R6, R7, R8, R9, R10], setter: (val: DefaultValue) => void) => void;
