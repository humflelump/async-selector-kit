...
var createdCount = 0;
function createThrottledSelectorResults(selectors, func, throttleFunc, id) {
    var _this = this;
    ...
    var _a = createAsyncSelectorResults_1.createAsyncSelectorResults({
        async: function () {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, func.apply(void 0, params)];
                });
            });
        },
        ...
        id: id
    }, selectors), getAsyncValue = _a[0], waiting = _a[1];
    var regularSelector = reselect_1.createSelector(selectors, func);
...
exports.createThrottledSelectorResults = createThrottledSelectorResults;
